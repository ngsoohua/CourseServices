    ...
    public static Student createStudentMenu( Scanner scanner ) throws ParseException
    {
        ...
        do {
            ...
            try {
                ...
                formatter.setLenient(false); //need to setLenient to false so that 22/22/2022 would not be accepted.
                birthDate = formatter.parse(scanner.next());

            }catch(ParseException e){
                System.out.println("Wrong Date Format !! Please key in MM/dd/yyyy");
            }
